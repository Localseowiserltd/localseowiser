...
const SLUG = 'local-seo-for-roofers'
...
/**
 * Industry page for Local SEO for Roofing Companies.
 * Content is owned by `src/data/industries/local-seo-for-roofers.ts`.
 */
const LocalSeoForRoofersPage = () => {
...
export default LocalSeoForRoofersPage
