...
const SLUG = 'local-seo-monroeville'
...
/**
 * Custom-path location page for Monroeville.
 * Content is owned by `src/data/locations/local-seo-monroeville.ts`.
 */
const LocalSeoMonroevillePage = () => {
...
export default LocalSeoMonroevillePage
