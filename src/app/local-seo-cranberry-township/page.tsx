...
const SLUG = 'local-seo-cranberry-township'
...
/**
 * Custom-path location page for Cranberry Township.
 * Content is owned by `src/data/locations/local-seo-cranberry-township.ts`.
 */
const LocalSeoCranberryTownshipPage = () => {
...
export default LocalSeoCranberryTownshipPage
