...
const SLUG = 'local-seo-north-hills'
...
/**
 * Custom-path location page for North Hills.
 * Content is owned by `src/data/locations/local-seo-north-hills.ts`.
 */
const LocalSeoNorthHillsPage = () => {
...
export default LocalSeoNorthHillsPage
