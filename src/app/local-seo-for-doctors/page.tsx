...
const SLUG = 'local-seo-for-doctors'
...
/**
 * Industry page for Local SEO for Doctors.
 * Content is owned by `src/data/industries/local-seo-for-doctors.ts`.
 */
const LocalSeoForDoctorsPage = () => {
...
export default LocalSeoForDoctorsPage
