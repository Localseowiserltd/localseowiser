...
const SLUG = 'local-seo-for-restaurants'
...
/**
 * Industry page for Local SEO for Restaurants.
 * Content is owned by `src/data/industries/local-seo-for-restaurants.ts`.
 */
const LocalSeoForRestaurantsPage = () => {
...
export default LocalSeoForRestaurantsPage
