...
const SLUG = 'local-seo-for-real-estate-agents'
...
/**
 * Industry page for Local SEO for Real Estate Agents.
 * Content is owned by `src/data/industries/local-seo-for-real-estate-agents.ts`.
 */
const LocalSeoForRealEstateAgentsPage = () => {
...
export default LocalSeoForRealEstateAgentsPage
