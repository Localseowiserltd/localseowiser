...
const SLUG = 'local-seo-for-insurance-agencies'
...
/**
 * Industry page for Local SEO for Insurance Agencies.
 * Content is owned by `src/data/industries/local-seo-for-insurance-agencies.ts`.
 */
const LocalSeoForInsuranceAgenciesPage = () => {
...
export default LocalSeoForInsuranceAgenciesPage
